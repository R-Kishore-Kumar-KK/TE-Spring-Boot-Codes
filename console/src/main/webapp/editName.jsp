...
<form action="./update1?changename=name" method="post">
		
		<input hidden="invisible" type="text" name="username" id="username" value="<%=request.getAttribute("uname")%>" required="required"> <br><br>
		
		<label>Name</label>
		<input class="input-field" type="text" name="firstname" id="firstname" value="<%=request.getAttribute("name")%>" required="required"> <br><br>
