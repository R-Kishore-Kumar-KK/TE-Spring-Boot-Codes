...
<body>
	...
	<form  action="./display"  method="post">
        <img class="image" src="./10982-200.png" alt="">
        <h1><i class="fas fa-sign-in-alt"></i> &nbsp; <u> Login Page</u></h1>
		
        <div class="input-container">
            <i class="fas fa-user icon"></i>
            <input class="input-field" type="text" name="username" id="username" placeholder="Enter the Username">    
        </div>
        ...
        <div class="input-container">
            ...
            <input class="input-field" type="password" name="password" id="password" placeholder="Enter the Password">
        </div>

        <br>

        <input class="check" type="checkbox" name="log" id="log">keep me logged in
