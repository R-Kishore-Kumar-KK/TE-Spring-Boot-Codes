...
<form action="./update2?changesalary=salary" method="post">
		
		<input hidden="invisible" type="text" name="username" id="username" value="<%=request.getAttribute("uname")%>" required="required"> <br><br>
		
		<label>Salary</label>
		<input class="input-field" type="number" name="salary" id="salary" value="<%=request.getAttribute("salary")%>" required="required"> <br><br>
